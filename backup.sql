...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_43E2D603_4FCD_4247_9EDB_4532D3322BB9 START WITH 3 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_E8C0696D_7768_43AA_9B14_FA68D1A91C15 START WITH 14 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A9C64184_FBD6_4CB4_ABD5_A7D7AE9DBE76 START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_F28B665E_D125_4041_A592_7A216473A730 START WITH 8 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_59DB99B1_B6D6_46EF_8FEF_617CA771E122 START WITH 2 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_38A2E23B_737C_467F_BD22_FBC1FC09FABA START WITH 3 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_7A480322_82AC_462A_AEDA_88208D9DAE89 START WITH 7 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_9566FAA4_4EE6_4BDC_A22F_C0B4482FA54A START WITH 3 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_49F82EAA_D0F3_4275_8E50_418B73C613C6 START WITH 6 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_20012AD4_355B_48BA_AFE8_0D68D653ACF4 START WITH 3 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_FE8D496D_70E3_493D_B2A6_D30652FF1CF2 START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_73AB604E_4D99_4D69_821B_E32BF91BB4E0 START WITH 5 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_55560A49_03A4_46FC_A0E7_69E54CD730BA START WITH 3 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_DBE65B66_06C7_44CE_B6AA_9D019B634305 START WITH 23 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_DCC9D1C5_6580_4D50_9841_FFCD1E8CE7D2 START WITH 3 BELONGS_TO_TABLE;    
CREATE CACHED TABLE PUBLIC.AUTHORITIES(
    AUTHORITIESID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_20012AD4_355B_48BA_AFE8_0D68D653ACF4) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_20012AD4_355B_48BA_AFE8_0D68D653ACF4,
...
CREATE CACHED TABLE PUBLIC.CART(
    CARTID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_DCC9D1C5_6580_4D50_9841_FFCD1E8CE7D2) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_DCC9D1C5_6580_4D50_9841_FFCD1E8CE7D2,
...
CREATE CACHED TABLE PUBLIC.CARTITEM(
    CARTITEMID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_E8C0696D_7768_43AA_9B14_FA68D1A91C15) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_E8C0696D_7768_43AA_9B14_FA68D1A91C15,
...
CREATE CACHED TABLE PUBLIC.COMMENT(
    COMMENTID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_59DB99B1_B6D6_46EF_8FEF_617CA771E122) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_59DB99B1_B6D6_46EF_8FEF_617CA771E122,
...
CREATE CACHED TABLE PUBLIC.CREDITCARD(
    CREDITCARDID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_55560A49_03A4_46FC_A0E7_69E54CD730BA) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_55560A49_03A4_46FC_A0E7_69E54CD730BA,
...
CREATE CACHED TABLE PUBLIC.CUSTOMER(
    CUSTOMERID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_43E2D603_4FCD_4247_9EDB_4532D3322BB9) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_43E2D603_4FCD_4247_9EDB_4532D3322BB9,
...
CREATE CACHED TABLE PUBLIC.CUSTOMERORDER(
    CUSTOMERORDERID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_73AB604E_4D99_4D69_821B_E32BF91BB4E0) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_73AB604E_4D99_4D69_821B_E32BF91BB4E0,
    CARTID INTEGER,
    CREDITCARDID INTEGER,
    CUSTOMERID INTEGER,
    SHIPPINGADDRESSID INTEGER
...
-- 4 +/- SELECT COUNT(*) FROM PUBLIC.CUSTOMERORDER;           
...
CREATE CACHED TABLE PUBLIC.RATING(
    RATINGID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A9C64184_FBD6_4CB4_ABD5_A7D7AE9DBE76) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A9C64184_FBD6_4CB4_ABD5_A7D7AE9DBE76,
...
CREATE CACHED TABLE PUBLIC.SHIPPINGADDRESS(
    SHIPPINGADDRESSID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_9566FAA4_4EE6_4BDC_A22F_C0B4482FA54A) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_9566FAA4_4EE6_4BDC_A22F_C0B4482FA54A,
...
CREATE CACHED TABLE PUBLIC.USERS(
    USERID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_38A2E23B_737C_467F_BD22_FBC1FC09FABA) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_38A2E23B_737C_467F_BD22_FBC1FC09FABA,
...
CREATE CACHED TABLE PUBLIC.SAVEDITEMS(
    SAVEDITEMSID INTEGER DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_49F82EAA_D0F3_4275_8E50_418B73C613C6) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_49F82EAA_D0F3_4275_8E50_418B73C613C6,
    CARTID INTEGER,
    PRODUCTID INTEGER
);          
ALTER TABLE PUBLIC.SAVEDITEMS ADD CONSTRAINT PUBLIC.CONSTRAINT_7 PRIMARY KEY(SAVEDITEMSID);   
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.SAVEDITEMS;              
INSERT INTO PUBLIC.SAVEDITEMS(SAVEDITEMSID, CARTID, PRODUCTID) VALUES
(5, 1, 9);             
...
ALTER TABLE PUBLIC.SAVEDITEMS ADD CONSTRAINT PUBLIC.FKD13D6199EBF266E FOREIGN KEY(CARTID) REFERENCES PUBLIC.CART(CARTID) NOCHECK;             
...
ALTER TABLE PUBLIC.SAVEDITEMS ADD CONSTRAINT PUBLIC.FKD13D619996F47F46 FOREIGN KEY(PRODUCTID) REFERENCES PUBLIC.PRODUCT(PRODUCTID) NOCHECK;   
