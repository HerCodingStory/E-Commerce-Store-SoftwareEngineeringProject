...
public class ProductController
{
    ...
    public String addCommentPost(@PathVariable(value = "productId") int productId, @Valid @ModelAttribute("comment") Comment comment, BindingResult result, HttpServletRequest request)
    {
        ...
        List<Comment> comList = product.getComment();
        comList.add(comment);

        product.setComment(comList);
        comment.setProduct(productService.getProductById(productId));
