...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Please update your information below:</p>
        </div>

        <form:form action="${pageContext.request.contextPath}/account/editCustomer" method="post" commandName="customer">
        ...
        <div class="form-group">
            ...
            <form:input path="shippingAddress.city" id="shippingCity" class="form-Control" value="${customer.shippingAddress.streetName}"/>
        </div>
